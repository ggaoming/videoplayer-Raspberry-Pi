...
- (void)playSampleClip1 {
    [self playStream:[NSURL URLWithString:movie_play_url]];
...
- (void)addDemoControl {
  ...
  UIButton *playSample1Button = [UIButton buttonWithType:UIButtonTypeCustom];
    //playSample1Button.backgroundColor = [UIColor redColor];
...
- (void)setShakingCode:(NSString*)code{
    VKVideoPlayerCaption * caption = nil;
    caption = [self testCaption:@"Japanese"];
    caption.CaptionshowType = @"hidden";
    [self.player setCaptionToTop:caption];
